export default function Topbar() {
  return (
    <div className="h-12 bg-[#1f5175] text-white px-10">
      <div className="max-w-[1200px] mx-auto h-full w-full flex flex-col items-center justify-center md:flex-row md:justify-between">
